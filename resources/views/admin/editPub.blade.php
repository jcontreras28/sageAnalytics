                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    @if ($publication->ignore_all_params == 1)
                                        <input checked="checked" name="ignore_all_params" type="checkbox" value='ignore_all_params' class='form-control'>
                                    @else
                                        <input name="ignore_all_params" type="checkbox" value='ignore_all_params' class='form-control'>
                                    @endif
                                </div>
                            </div>
